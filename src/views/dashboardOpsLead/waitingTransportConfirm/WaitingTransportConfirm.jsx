...
import TableListWaitingTransportConfirm from 'src/components/dashboardOpsLead/waitingTransportConfirm/TableListWaitingTransportConfirm'
import HeaderProject from '../HeaderProject'

function WaitingTransportConfirm() {
    ...
    useEffect(() => {
        ...
        if (Global?.user?.userID) {
            dispatch(
                ...
                dispatch(actions.getListWaitingTransportConfirm(pId, wId, Global?.user?.userID))
            })
        }
    }, [Global?.user?.userID]);
                    ...
                    <CCardBody>
                        ...
                        <CRow className='mt-2'>
                            <CCol className="d-none d-md-block text-end">
                                <TableListWaitingTransportConfirm
                                    data={DashboardOpsLead?.listWaitingTransporComplete}
...
export default WaitingTransportConfirm